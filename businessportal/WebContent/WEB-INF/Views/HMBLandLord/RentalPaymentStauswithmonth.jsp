...
<title>Rental Payment Status with month</title>
		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				...
				<div class="row mt mb" style="padding-top: 7px">
					...
					<div class="col-lg-2 col-md-1 col-sm-6 col-xs-5">
						<label class="label_stru">Vendor Name</label>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5"
						style="padding: 1px !important;">
...
<!-- 						<label class="label_stru">Outstanding Amount</label> -->
<!-- 					</div> -->
...
<!-- 					</div> -->
				...
				<div class="row mb">
					<div class="col-lg-2 col-md-1 col-sm-6 col-xs-5">
						<label class="label_stru">From Date</label>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5"
						style="padding: 1px !important;">
					...
					<div class="col-lg-2 col-md-1 col-sm-6 col-xs-5">
						<label class="label_stru">To Date</label>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5"
						style="padding: 1px !important;">
...
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6"> -->
<!-- 						<label class="label_stru">Item Type</label> -->
<!-- 					</div> -->
...
<!-- 						<div id="itemType" style="float: left;"></div> -->
						<button  id="getBtn"
							class="btn btn-success btn-sm">Get</button>
					</div>
	...
	<script
		src="resources/js/custom/hmbLandLord/RentalPaymentStauswithmonth.js"></script>
...
// 			      });
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Rental Payment Staus with month', function (data) {
		...
		var source_inventory = {
			datatype:'json',
			datafields:fields,
			url:'getRentalPaymentStauswithmonth?selected_from_date='+from_out_report_date+'&selected_to_date='+to_out_report_date+'&itemType='+itemType,
			async:false
		}
