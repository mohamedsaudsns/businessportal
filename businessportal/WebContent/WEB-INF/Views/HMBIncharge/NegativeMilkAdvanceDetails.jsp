			...
			<section class="wrapper site-min-height">
				<%@include file="../Breadcrump.jsp" %>
					...
					<div class="row mt mb" style="padding-top: 7px">
							...
							<div class="col-lg-2 col-md-1 col-sm-6 col-xs-5" >Vendor Code</div>
						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding: 1px !important;" >
							
								<input type="text" id="vendorCode"   />
						</div>
						
							<div class="col-lg-2 col-md-1 col-sm-6 col-xs-5"  >Vendor Name</div>
...
<!-- 					</div>  -->
	...
	<script src="resources/js/custom/hmb-incharge/NegativeMilkAdvanceDetails.js"></script>
...
// 			      });
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Negative Milk Advance Details', function (data) {
