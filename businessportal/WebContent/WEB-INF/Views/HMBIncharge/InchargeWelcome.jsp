				  ...
				  <div class="row mt">
                      <div class="col-lg-6">
                          <div class="content-panel">
							  <h4><i class="fa fa-angle-right" style="color: #ea2424;"></i> Average LPD</h4>
                              <div class="panel-body text-center">
                                	<canvas id="avg-lpd-bar-chart" width="800" height="450"></canvas>
                              </div>
                          </div>
                      </div>
                       <div class="col-lg-6">
                          <div class="content-panel">
							  <h4><i class="fa fa-angle-right" style="color: #ea2424;"></i> No Of Farmers</h4>
                              <div class="panel-body text-center">
                                	<canvas id="no-of-farmers-bar-chart" width="800" height="450"></canvas>
                              </div>
                          </div>
                      </div>
                   ...
                   <div class="row mt">
                      <div class="col-lg-6">
                          <div class="content-panel">
							  <h4><i class="fa fa-angle-right" style="color: #ea2424;"></i> Fat % and SNF % </h4>
                              <div class="panel-body text-center">
                                	<canvas id="fat-snf-bar-chart" width="800" height="450"></canvas>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel">
							  <h4><i class="fa fa-angle-right" style="color: #ea2424;"></i> Feed in Kgs</h4>
                              <div class="panel-body text-center">
                                	<canvas id="feed-kgs-bar-chart" width="800" height="450"></canvas>
                              </div>
                          </div>
                      </div>
...
<script src="resources/js/custom/Auth.js"></script>
	<script src="resources/js/charts-js/Chart.min.js"></script>
	<script src="resources/js/custom/hmb-incharge/InchargeWelcome.js"></script>
	<script src="resources/js/jquery-confirm.min.js"></script>
		...
		$(document).ready(function(e) {
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Dashboard', function (data) {
