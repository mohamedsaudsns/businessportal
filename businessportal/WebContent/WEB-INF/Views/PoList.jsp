...
<!-- 						</div> -->
				 ...
				 <div class="row mb">												
						...
						<div class="col-lg-2 col-md-1 col-sm-6" ><button style="float: right;     margin-right: 15px;"  id="getBtn" class="btn btn-success btn-sm">Get</button></div>
<!-- 						<div class="col-lg-2 col-md-2 col-sm-6" style="padding: 1px !important;" > -->
...
<!-- 						</div>						 -->
	...
	<script src="resources/js/custom/PoList.js"></script>
