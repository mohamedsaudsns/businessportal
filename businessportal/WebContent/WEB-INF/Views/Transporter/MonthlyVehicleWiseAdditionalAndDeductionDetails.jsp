...
<title>Monthly Vehicle Wise Additional And Deduction Details</title>
...
<!-- 						</div> -->
				 ...
				 <div class="row mb">												
						...
						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5" style="padding: 1px !important;" >
							...
							<div class="col-lg-2 col-md-1  col-xs-5" ><label class="label_stru">To Date</label></div>
						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5" style="padding: 1px !important;" >
...
<!-- 						</div> -->
	...
	<script src="resources/js/custom/Transporter/MonthlyVehicleWiseAdditionalAndDeductionDetails.js"></script>
...
// 			      });
			...
			$.ajax({
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Additional And Deduction Details', function (data) {
