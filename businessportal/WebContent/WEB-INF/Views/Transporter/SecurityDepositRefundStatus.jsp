...
<title>Security Deposit Refund Status</title>
...
<!-- 					</div>  -->
	...
	<script src="resources/js/custom/Transporter/SecurityDepositRefundStatus.js"></script>
	<script src="resources/js/jquery-confirm.min.js"></script>
		...
		$(document).ready(function(e) {
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Security Deposit Refund Status', function (data) {
