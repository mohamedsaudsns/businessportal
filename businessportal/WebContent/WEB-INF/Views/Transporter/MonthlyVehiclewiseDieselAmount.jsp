...
<title>Monthly Vehicle Wise Diesel Amount</title>
...
<!-- 						</div> -->
	...
	<script src="resources/js/custom/Transporter/MonthlyVehiclewiseDieselAmount.js"></script>
...
// 			      });
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Monthly Vehicle wise Diesel Amount', function (data) {
