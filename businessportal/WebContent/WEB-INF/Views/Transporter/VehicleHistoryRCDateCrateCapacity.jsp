...
<title>Vehicle History RC Date CrateCapacity</title>
...
<!-- 				 <div class="row mb">												 -->
<!-- 						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5" ><label class="label_stru">From Date</label></div> -->
<!-- 						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5" style="padding: 1px !important;" > -->
<!-- 							<div id="from_out_report_date"></div> -->
<!-- 						</div> -->
						
<!-- 							<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5" ><label class="label_stru">To Date</label></div> -->
<!-- 						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5" style="padding: 1px !important;" > -->
...
<!-- 					</div>  -->
	...
	<script src="resources/js/custom/Transporter/VehicleHistoryRCDateCrateCapacity.js"></script>
...
// 			});
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Vehicle History RCDate Crate Capacity', function (data) {
