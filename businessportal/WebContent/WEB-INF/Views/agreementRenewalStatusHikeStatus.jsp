...
<title>Agreement Renewal Status Hike Status</title>
...
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Agreement No</div> -->
...
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Start Date</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" -->
<!-- 						style="padding: 1px !important;"> -->
...
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">End Date</div> -->
...
<!-- 				</div> -->
<!-- 				<div class="row mb"> -->
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Advance Amount</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" -->
<!-- 						style="padding: 1px !important;"> -->
<!-- 						<input type="text" id="advanceAmount" /> -->
<!-- 					</div> -->

<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Rent Amount</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" -->
<!-- 						style="padding: 1px !important;"> -->
...
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Renewal Type</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" style="padding-left: 3px;"> -->
...
<!-- 				<div class="row mb"> -->
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">No Of Years</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" -->
<!-- 						style="padding: 1px !important;"> -->
<!-- 						<input type="text" id="noOfYears" /> -->
<!-- 					</div> -->

<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Renewal Date</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" -->
<!-- 						style="padding: 1px !important;"> -->
...
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Rent Increment(%)</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" style="padding-left: 3px;"> -->
...
<!-- 				<div class="row mb"> -->
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Rent Increment Year</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" -->
<!-- 						style="padding: 1px !important;"> -->
<!-- 						<input type="text" id="rentIncrYear" /> -->
<!-- 					</div> -->

<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Plant</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" -->
<!-- 						style="padding: 1px !important;"> -->
...
<!-- 					<div class="col-lg-2 col-md-1 col-sm-6">Notice Period</div> -->
<!-- 					<div class="col-lg-2 col-md-2 col-sm-6" style="padding-left: 3px;"> -->
...
<!-- 				</div> -->
	...
	<script src="resources/js/custom/agreementRenewalStatusHikeStatus.js"></script>
