...
<body>
	...
	<script
		src="resources/js/custom/FiledForce.js"></script>
...
<script type="text/javascript">
		...
		fields.push({name:'designation',type:'string'},{name:'empName',type:'string'},{name:'empMobileNo',type:'string'},{name:'empEmailId',type:'string'});

		var source_inventory = {
			datatype:'json',
			datafields:fields,
			url:'getfiledForceData',
			async:false
		}
