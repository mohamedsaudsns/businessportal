...
<body>
	...
	<script src="resources/js/custom/NewProductLaunch.js"></script>
...
<script type="text/javascript">
	...
	function getProductImageList(depId) {
		...
		$.getJSON('getProductByDepartment?departmentId=' + depId, function(data) {
			$.each(data, function(index, value) {
				...
				$.each(this, function(k, v) {
					...
					if (k === 0) {
						output += '<div class="item active"><iframe src="productImageById?itemNo=' + v.itemNo + '&compCode=' + v.compCode + '&departmentId=' + v.department + '"" width="900" height="500" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe> <div class="carousel-caption"><h3>'+v.productName+'</h3><p></p> </div></div>';
					} else {

						output += '<div class="item"><iframe src="productImageById?itemNo=' + v.itemNo + '&compCode=' + v.compCode + '&departmentId=' + v.department + '"" width="900" height="500" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe> <div class="carousel-caption"><h3>'+v.productName+'</h3><p></p> </div></div>';
					}
