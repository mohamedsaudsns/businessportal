...
<title>Milk Month Average</title>
							...
							<table class="table table-bordered table-fixed" id="footerTotal">
								...
								<tbody>
									<tr id="payementTotalLtrsTr">
										...
										<td class='table-header-align-left'>Total QTY</td>
...
<!-- 										<td class='table-header-align-left'>Total FAT</td> -->
...
<!-- 										<td class='table-header-align-left'>Total SNF</td> -->
...
<!-- 								</tr> -->
	...
	<script src="resources/js/custom/hmb/AverageMilkMonthAverage.js"></script>
	 ...
	 $('select option').each(function () {
		...
		$(document).ready(function(e) {
			...
			$('#lastThreeMonthYear option:last-child').attr('selected', 'selected');
			 ...
			 $.getJSON('getDailyUpdateDate?menuName=Milk Month Average', function (data) {
