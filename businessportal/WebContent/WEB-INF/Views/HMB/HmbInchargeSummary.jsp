...
<!-- 					</div> -->
					...
					<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" ><label class="label_stru">Deposit Total Amount</label></div>
						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-4"   id="cust-input-padding" style="padding-left: 3px;" >
						...
						<table class="table table-bordered table-fixed" id="payemntTable">
							...
							<thead style="backgroud-color: aliceblue;">
								<tr>
									...
									<th class="table-header_align_payment">Milk type</th>
...
<!-- 									</tr> -->
	...
	<script src="resources/js/custom/hmb/HmbInchargeSummary.js"></script>
...
// 				}
		...
		$(document).ready(function(e) {
			...
			$.ajax({
				type : "GET",
					url : "getDepositeOutstandingAmount",
...
// var hmbMonth = $('#hmbMonth').val();
			...
			var source_deposite_amount = {
				datatype : 'json',
				datafields : depositefields,
				url : 'getDepositAmountReport?selected_month=' + hmbMonth + '&itemType=' + itemType,
				async : false
			}
			var dataAdapter_deposite_amount = new $.jqx.dataAdapter(source_deposite_amount);
			$('#DepositeReportGrid').jqxGrid({
				source : source_deposite_amount
			});
