...
<!-- 					</div> -->
					...
					<iframe id="testIframe" style="border: 0; width: 100%; "  height="680" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen scrolling="auto"></iframe>
				</div>
			</div>
	...
	<script src="resources/js/custom/hmb/Circular.js"></script>
