...
<title>Additional Consumption Deposit Status</title>
				...
				<%@include file="Breadcrump.jsp"%>
					...
					<div class="row mt mb" style="padding-top:5px ">
						...
						<div class="col-lg-2 col-md-2 col-sm-6" style="padding: 1px !important;" >
							...
							<div class="col-lg-2 col-md-2 col-sm-6"  ><label class="label_stru">Vendor Name</label></div>
...
<!-- 						</div> -->
	...
	<script src="resources/js/custom/additionalConsumptioDepositStatus.js"></script>
