...
<title>News Letter Upload</title>
...
<!--[if lt IE 9]>
	...
	<%
		String userIdl = (String) session.getAttribute("userId");
...
<body>
	<section id="container">
      ...
      *********************************************************************************************************************************************************** -->
			...
			<section class="wrapper site-min-height">
				<%@include file="../DemoBreadcrump.jsp" %>
					...
					<form:form action="tdsFileUpload" method="POST" id="tdsFileUpload" enctype="multipart/form-data">
							...
							<div class="col-lg-2 col-md-1 col-sm-6" >News Letter Upload</div>
		...
		<!--footer end-->
		<input type="hidden" id="userId" value="<%=userIdl%>">
...
<script src="resources/js/custom/Auth.js"></script>
	...
	<script src="resources/js/jquery-confirm.min.js"></script>
		...
		$("#tdsFileUploadok").on('click',function(e){
			...
			if(image!==''){
			  $.ajax({
			    url: 'FiledForceFileUploadAction',
			    type: 'POST',
			    data: formData,
