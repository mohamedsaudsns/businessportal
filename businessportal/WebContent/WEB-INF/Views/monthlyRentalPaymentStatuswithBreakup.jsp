...
<title>Monthly Rental Payment Status with Breakup</title>
...
<!-- 					</div> -->
				...
				<div class="row mb">
					...
					<div class="col-lg-2 col-md-2 col-sm-6"
						...
						<button style="float: right; margin-right: 15px;" id="getBtn"
	...
	<script
		src="resources/js/custom/monthlyRentalPaymentStatuswithBreakup.js"></script>
