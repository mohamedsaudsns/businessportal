...
$(document).ready(function(e){
	...
	$('#BillPaymentDetail').addClass("active");
//	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Bill Payment Detail</a></li>");
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'></span> Bill Payment Detail</a></li>");
...
//			height : '25',  dropDownHeight: 100});
	...
	$('#oustandingReportGrid').jqxGrid({
		...
		{text:'Date',datafield:'postingDate',width:'12%',cellsalign: 'center', align: 'center',columntype: 'date', cellsformat: 'dd/MM/yyyy',},
		         ...
		         {text:'Reference No',datafield:'remark',width:'15%', align: 'center'},
		         ...
		         {text:'Remark',datafield:'itemText',width:'21%', align: 'center'},		
		         ...
		         {text:'Bill Payment Amount',datafield:'rentAmount',width:'13%',align: 'center', cellsalign: 'right'},		
...
//		         {text:'30 - 45',datafield:'to45',width:'10%',cellsalign: 'right', align: 'center'},
	...
	var	itemType= "ALL";
			...
			fields.push({name:'vendorcode',type:'string'},{name:'docNo',type:'string'},{name:'fiYear',type:'string'},{name:'remark',type:'string'},
						...
						,{name:'rentAmount',type:'string'},{name:'itemText',type:'string'},{name:'tdsAmount',type:'string'},{name:'netAmount',type:'string'});

			var source_inventory = {
				datatype:'json',
				datafields:fields,
				url:'getBillPaymentDetailsReport?selected_from_date='+from_out_report_date+'&selected_to_date='+to_out_report_date+'&itemType='+itemType,
				async:false
			}
