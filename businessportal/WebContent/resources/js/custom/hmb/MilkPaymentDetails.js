...
$(document).ready(function(e){
	...
	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Milk Payment Detail</a></li>");
	...
	$('#oustandingReportGrid').jqxGrid({
		...
		{text:'Date',datafield:'postingDate',width:'12%',cellsalign: 'center', align: 'center',columntype: 'date', cellsformat: 'dd/MM/yyyy',},
		         ...
		         {text:'Doc Type',datafield:'docTypeName',width:'18%', align: 'center'},		
		         {text:'Remark',datafield:'remark',width:'20%', align: 'center'},		
		         ...
		         {text:'Debit ',datafield:'debitAmount',width:'11%',align: 'center', cellsalign: 'right'},	
		         {text:'Credit ',datafield:'creditAmount',width:'11%',align: 'center', cellsalign: 'right'},		
...
//		         {text:'30 - 45',datafield:'to45',width:'10%',cellsalign: 'right', align: 'center'},
	...
	var	itemType= $('#itemType').val();
			...
			fields.push({name:'vendorcode',type:'string'},{name:'docNo',type:'string'},{name:'fiYear',type:'string'},{name:'remark',type:'string'},
						...
						,{name:'0_15',type:'string'},{name:'15_30',type:'string'},{name:'30_45',type:'string'},{name:'vendorName',type:'string'},{name:'paymentAmou',type:'string'});

			var source_inventory = {
				datatype:'json',
				datafields:fields,
				url:'getOutstandingMonthlyReport?selected_from_date='+from_out_report_date+'&selected_to_date='+to_out_report_date+'&itemType='+itemType,
				async:false
			}
