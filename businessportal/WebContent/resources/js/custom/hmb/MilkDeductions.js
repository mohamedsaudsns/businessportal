...
$(document).ready(function(e) {
	...
	$('#MilkDeductions').addClass("active");

	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'></span> Farmer Deduction</a></li>");
