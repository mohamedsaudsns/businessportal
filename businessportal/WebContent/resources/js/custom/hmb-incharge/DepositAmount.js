...
$(document).ready(function(e){
	...
	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Deposit Amount</a></li>");
...
//	$('#outstandingAmount').jqxInput({width:'100%',theme:theme,height:25,disabled:true});
	...
	var	itemType= "Open";
			...
			var source_inventory = {
				datatype:'json',
				datafields:fields,
				url:'getDepositAmountReport?selected_from_date='+from_out_report_date+'&selected_to_date='+to_out_report_date+'&itemType='+itemType,
				async:false
			}
