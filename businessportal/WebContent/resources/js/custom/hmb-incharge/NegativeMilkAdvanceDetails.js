...
$(document).ready(function(e){
	...
	$('#NegativeMilkAdvanceDetails').addClass("active");
//	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Negative Milk Advance Details</a></li>");
	
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'></span> Negative</a></li>");
...
//	$('#outstandingAmount').jqxInput({width:'100%',theme:theme,height:25,disabled:true});
	...
	$('#oustandingReportGrid').jqxGrid({
		...
		{text:'Date',datafield:'postingDate',width:'12%',cellsalign: 'center', align: 'center',columntype: 'date', cellsformat: 'dd/MM/yyyy',hidden:true},
		         ...
		         {text:'Reference No',datafield:'docNo',width:'13%',cellsalign: 'center', align: 'center',hidden:true},
		         {text:'Year',datafield:'fiYear',width:'10%',cellsalign: 'center', align: 'center',hidden:true},
		         {text:'Description',datafield:'splGlDesc',width:'73%',align: 'center'},
		         
		         
		         {text:'Doc Type',datafield:'docTypeName',width:'18%', align: 'center',hidden:true},		
		         {text:'Remark',datafield:'remark',width:'41%', align: 'center',hidden:true},		
		         ...
		         {text:'Amount',datafield:'securityDepositAmount',width:'20%',align: 'center', cellsalign: 'right',cellsformat: 'c2'
		        	 , aggregates: ['sum']},		
		         ...
		         {text:'Amount ',datafield:'amount',width:'23%',align: 'center', cellsalign: 'right',hidden:true
       }
     ]
	...
	var	itemType= "Open";
			...
			fields.push({name:'vendorcode',type:'string'},{name:'docNo',type:'string'},{name:'fiYear',type:'string'},{name:'remark',type:'string'},
						...
						,{name:'splGlDesc',type:'string'});

			var source_inventory = {
				datatype:'json',
				datafields:fields,
				url:'NegativeMilkAdvanceDetailsReport?itemType='+itemType,
				async:false
			}
