...
//	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Monthly Vehicle Wise Diesel Amount</a></li>");
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'></span> Monthly Vehicle Wise Diesel Amount</a></li>");
...
//	$('#outstandingAmount').jqxInput({width:'100%',theme:theme,height:25,disabled:true});
	...
	$('#oustandingReportGrid').jqxGrid({
		...
		{text:'Date',datafield:'postingDate',width:'12%',cellsalign: 'center', align: 'center',columntype: 'date', cellsformat: 'dd/MM/yyyy',},
		         ...
		         {text:'Vehicle No',datafield:'vechNO',width:'14%',cellsalign: 'center', align: 'center'},
		         {text:'Reference No',datafield:'docNo',width:'12%',cellsalign: 'center', align: 'center'},
		         {text:'Year',datafield:'fiYear',width:'8%',cellsalign: 'center', align: 'center'},
		         {text:'Doc Type',datafield:'docTypeName',width:'18%', align: 'center',hidden:true},		
		         {text:'Remark',datafield:'remark',width:'24%', align: 'center'},		
		         ...
		         {text:'Assigment',datafield:'assigment',width:'25%',cellsalign: 'center', align: 'center',hidden:true},
		         {text:'Bunk Name',datafield:'bunkName',width:'16%', align: 'center'},
		         
		         
		         {text:'Diesel Amount',datafield:'securityDepositAmount',width:'17%',align: 'center', cellsalign: 'right',cellsformat: 'c2'
		        	 , aggregates: ['sum']},		
	...
	var	itemType= "All";
			...
			fields.push({name:'vendorcode',type:'string'},{name:'docNo',type:'string'},{name:'fiYear',type:'string'},{name:'remark',type:'string'},
						...
						,{name:'assigment',type:'string'},{name:'vechNO',type:'string'},{name:'bunkName',type:'string'}		);

			var source_inventory = {
				datatype:'json',
				datafields:fields,
				url:'getMonthlyVehiclewiseDieselAmountReport?selected_from_date='+from_out_report_date+'&selected_to_date='+to_out_report_date+'&itemType='+itemType+'&docType=KG',
				async:false
			}
