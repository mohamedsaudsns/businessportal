...
//	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Vehicle History RC Date CrateCapacity</a></li>");
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'></span> Vehicle History RC Date CrateCapacity</a></li>");
...
//		{text:'Date',datafield:'postingDate',width:'12%',cellsalign: 'center', align: 'center',columntype: 'date'},
    ...
    {text:'Vehicle Vendor Code' ,datafield:'vendorVechileCode',width:'15%',cellsalign: 'center', align: 'center'},
   
		         {text:'Truck No',datafield:'truckNo',width:'10%',cellsalign: 'center', align: 'center'},
		         {text:'Vehicle Model 1',datafield:'vehcileModel1',width:'25%', align: 'center'},
		         {text:'Vehicle Model 2',datafield:'vehcileModel2',width:'15%', align: 'center'},
		         {text:'Name',datafield:'name',width:'20%',cellsalign: 'center', align: 'center'},
		         {text:'Permit Status',datafield:'permitStatus',width:'10%',cellsalign: 'center', align: 'center'},
		         ...
		         {text:'Vehicle Status',datafield:'vehicleStatus',width:'10%', align: 'center',cellsalign: 'center'},
...
//	var	to_out_report_date= $('#to_out_report_date').val();
	...
	var	itemType= "ALL";
			...
			fields.push({name:'truckNo',type:'string'},{name:'name',type:'string'},{name:'permitStatus',type:'string'},{name:'crateCapacity',type:'string'},
					{name:'vendorVechileCode',type:'string'},{name:'vehcileModel1',type:'string'},{name:'vehcileModel2',type:'string'},
						{name:'rcDate',type: 'date', format: 'dd/mm/yyyy'},{name:'dieselCardNumber',type:'string'},{name:'vehicleStatus',type:'string'});
