...
$(document).ready(function(e){
	...
	$('#NewScheme').addClass("active");
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'></span> New Scheme Launch</a></li>");
