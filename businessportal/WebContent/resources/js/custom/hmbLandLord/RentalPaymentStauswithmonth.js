...
$(document).ready(function(e){
	...
	$('#RentalPaymentStauswithmonth').addClass("active");
//	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Monthly Rental Payment Status with Breakup</a></li>");
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'></span> Rental Payment Status with Breakup</a></li>");

var last6Month= addMonths(new Date(), -6);
