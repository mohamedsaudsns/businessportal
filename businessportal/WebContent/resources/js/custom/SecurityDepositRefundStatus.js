...
$(document).ready(function(e){
	...
	$('#SecurityDepositRefundStatus').addClass("active");
//	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Security Deposit Refund Status</a></li>");
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-arrow-right'></span> Security Deposit Refund Status</a></li>");
	...
	$('#oustandingReportGrid').jqxGrid({
		...
		{text:'Date',datafield:'postingDate',width:'12%',cellsalign: 'center', align: 'center',columntype: 'date', cellsformat: 'dd/MM/yyyy',},
		         ...
		         {text:'Vehicle No',datafield:'vehicleNo',width:'14%',cellsalign: 'center', align: 'center'},
		         ...
		         {text:'Security Deposit Amount',datafield:'securityDepositAmount',width:'15%',align: 'center', cellsalign: 'right',cellsformat: 'c2'
		        	 , aggregates: ['sum']},		
