...
$(document).ready(function(e){
	...
	$('#TransportationCharges').addClass("active");
//	$("#breadcrumb-ol").append("<li class='breadcrumb-item active style=font-size: 16px;'><a href='#'>Transportation Charges</a></li>");
	$("#breadcrumb-ol").append("<li style='font-size: 14px;'><a href='#'><span class='fa fa-chevron-circle-right' id='header_span_icon'	></span> Transportation Charges</a></li>");
...
//		         {text:'30 - 45',datafield:'to45',width:'10%',cellsalign: 'right', align: 'center'},
	...
	var itemType="b";
			...
			var source_inventory = {
				datatype:'json',
				datafields:fields,
				url:'getTransportationChargeReport?selected_from_date='+from_out_report_date+'&selected_to_date='+to_out_report_date+'&itemType='+itemType,
				async:false
			}
