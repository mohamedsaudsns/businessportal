...
/**
 * The primary key class for the milk_bouns database table.
 * 
 */
@Embeddable
public class MilkBounPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MilkBounPK)) {
			return false;
		}
		MilkBounPK castOther = (MilkBounPK)other;
		return 
