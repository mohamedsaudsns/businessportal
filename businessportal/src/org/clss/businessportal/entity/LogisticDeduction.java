...
/**
 * The persistent class for the logistic_deduction database table.
 * 
 */
@Entity
@Table(name="logistic_deduction")
@NamedQuery(name="LogisticDeduction.findAll", query="SELECT l FROM LogisticDeduction l")
public class LogisticDeduction implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private LogisticDeductionPK id;
	...
	public LogisticDeductionPK getId() {
		return this.id;
	}

	public void setId(LogisticDeductionPK id) {
		this.id = id;
	}
