...
/**
 * The persistent class for the milk_bouns database table.
 * 
 */
@Entity
@Table(name="milk_bouns")
@NamedQuery(name="MilkBoun.findAll", query="SELECT m FROM MilkBoun m")
public class MilkBoun implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MilkBounPK id;
	...
	public MilkBounPK getId() {
		return this.id;
	}

	public void setId(MilkBounPK id) {
		this.id = id;
	}
