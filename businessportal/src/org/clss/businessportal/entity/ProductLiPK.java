...
/**
 * The primary key class for the product_li database table.
 * 
 */
@Embeddable
public class ProductLiPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ProductLiPK)) {
			return false;
		}
		ProductLiPK castOther = (ProductLiPK)other;
		return 
