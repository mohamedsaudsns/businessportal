...
/**
 * The primary key class for the user_role_assignment database table.
 * 
 */
@Embeddable
public class UserRoleAssignmentPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof UserRoleAssignmentPK)) {
			return false;
		}
		UserRoleAssignmentPK castOther = (UserRoleAssignmentPK)other;
		return 
