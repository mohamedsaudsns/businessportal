...
/**
 * The primary key class for the milk_deduction database table.
 * 
 */
@Embeddable
public class MilkDeductionPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MilkDeductionPK)) {
			return false;
		}
		MilkDeductionPK castOther = (MilkDeductionPK)other;
		return 
